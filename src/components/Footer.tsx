            ...
            <div className="max-w-[1200px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-10 mb-10 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-2.5 list-none">
                            <li><a href="/privacy" className="text-text-secondary text-sm hover:text-accent transition-colors no-underline">{t.footer.privacy}</a></li>
                            <li><a href="/terms" className="text-text-secondary text-sm hover:text-accent transition-colors no-underline">{t.footer.terms}</a></li>
                            <li><a href="mailto:contact@bettacool.com" className="text-text-secondary text-sm hover:text-accent transition-colors no-underline">{t.footer.contact}</a></li>
                        </ul>
                    </div>
                </div>
